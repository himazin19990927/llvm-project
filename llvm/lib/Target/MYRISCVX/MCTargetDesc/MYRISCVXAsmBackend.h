...
public:
  ...
  MYRISCVXAsmBackend(const Target &T, const MCRegisterInfo &MRI,
                     const Triple &TT, StringRef CPU, bool Is64Bit)
      : MCAsmBackend(support::little), TheTriple(TT), Is64Bit(Is64Bit) {}
  // @} MYRISCVXAsmBackend_h_MYRISCVXAsmBackend_createObjectTargetWriter ...
